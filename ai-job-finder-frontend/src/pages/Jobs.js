...
export default function Jobs() {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 16px", fontFamily: "sans-serif" }}>
      <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 20, color: "#006491" }}>
        {t.availableJobs}
      </h2>

      {jobs.length === 0 && (
        <p style={{ color: "#6b7280" }}>{t.noJobs}</p>
      )}
      ...
      <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
        {jobs.map((job) => (
          ...
          >
            ...
            <h3 style={{ fontSize: 17, fontWeight: 700, margin: "0 0 6px", color: "#111" }}>
            ...
            {job.rating > 0 && (
              <p style={{ fontSize: 13, margin: "4px 0", color: "#f59e0b" }}>
                ⭐ {job.rating} ({job.totalReviews} {t.reviews})
              </p>
            )}

            <p style={{ fontSize: 14, fontWeight: 700, color: "#E8002A", margin: "6px 0" }}>
              ₹{job.salary}
            </p>

            <p style={{ fontSize: 13, margin: "4px 0", color: "#6b7280" }}>
              {t.payment}: {job.paymentMethod}
            </p>
            ...
            <button
              ...
              style={{
                ...
                marginTop: 12, fontWeight: 600, fontSize: 14,
                width: "100%",
              }}
            >
              {t.viewDetails}
